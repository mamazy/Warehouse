...
function goBack() {
   ...
   <title>BEARING LOCATION Result - Secured</title>
</head>
<body>
<?php
...
$sql = "SELECT * FROM `BEARING` WHERE `STATUS` LIKE '%".$_POST['id']."%'";
...
echo "</table><br><center><button class=button onclick=goBack()>TRY ANOTHER STATUS</button></center>";
} else {
echo "<center color=red><img src=img/error.png /><br />INCORRECT STATUS<br><button class=button onclick=goBack()>TRY ANOTHER STATUS</button><br></center>";
}
$conn->close();
?>
