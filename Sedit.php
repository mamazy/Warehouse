...
<table id=parts><tr><th>SEQ</th><th>PART NAME</th><th>PART NUMBER</th><th>QTY</th><th>CONDITION</th><th>PRICE USD</th></tr>

<tr><td><?php echo $SEQ;?></td><td><?php echo $PARTNAME;?></td><td><?php echo $PARTNUMBER;?></td><td><?php echo $QTY;?></td><td><?php echo $COND;?></td><td><?php echo $PRICE;?></td></tr>
    ...
    <form name="form1" method="post" action="Seditt.php">
        <table border="0">
                       <tr> 
