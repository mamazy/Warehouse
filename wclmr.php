...
$sql = "SELECT * FROM `ANBAR` WHERE `SOTOON` = '".$_POST['id']."'";
...
echo "</table><br><center><button class=btn onclick=goBack()>TRY ANOTHER COLUMN</button></center>";
} else {
echo "<center color=red><img src=img/error.png /><br />INCORRECT COLUMN<br><button class=button onclick=goBack()>TRY ANOTHER COLUMN</button><br></center>";
}
$conn->close();
?>
