...
function goBack() {
   ...
   <title>CAT Part Name RESULT - Secured</title>
</head>
<body>
<?php
...
$sql = "SELECT PN , DES, PRICE, WEIGHT  FROM CAT  WHERE DES  LIKE '%".$_POST['id']."%'";
...
echo "<center color=red><img src=img/error.png /><br />INCORRECT PART NUMBER<br><button class=button onclick=goBack()>TRY ANOTHER PART NAME</button><br></center>";
}
$conn->close();
?>
