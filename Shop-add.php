...
if(isset($_POST['Submit'])) {    
    ...
    if(empty($SEQ) || empty($PARTNAME) || empty($PARTNUMBER)|| empty($QTY)|| empty($COND)|| empty($PRICE)) {                
        ...
        $result = mysqli_query($mysqli, "INSERT INTO SHOP (SEQ,PARTNAME,PARTNUMBER,QTY,COND,PRICE) VALUES('$SEQ','$PARTNAME','$PARTNUMBER','$QTY','$COND','$PRICE')");
        
        //display success message
        echo "<font color='green'>Data added successfully.";
        echo "<br/><a href='Shop-add-data.php'>ADD ANOTHER PART TO SHOP</a>";
    }
}
?>
</body>
