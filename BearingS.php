...
function goBack() {
   ...
   <title>Bearing LOCATION Search - Secured</title>
</head>
<body>
<?php
...
<div id="w">
   <center> 
   <img src="img/BEARING.jpg"><CENTER><B>LOCATION STATUS</B></CENTER>
   <form action="BearingSresult.php" class=" sign-in" method="post" name="formu" id="formu">
