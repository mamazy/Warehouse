...
function goBack() {
   ...
   <title>KME PART # RESULT - Secured</title>
</head>
<body>
<?php
...
echo "<table id=parts><tr><th>ID</th><th>PART NAME</th><th>PART NUMBER</th><th>INT PART NUMBER</th><th>WEIGHT (LBS)</th><th>FOB PRICE USD</th></tr>";
