...
function goBack() {
   ...
   <title>Bearing Part Name Search - Secured</title>
</head>
<body>
<?php
...
<div id="w">
   <center> 
   <img src="img/BEARING.jpg"><CENTER><b>BRAND SEARCH</b></CENTER>
   <form action="BearingNresult.php" class=" sign-in" method="post" name="formu" id="formu">
