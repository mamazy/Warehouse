...
<table id=parts><tr><th>SEQ</th><th>PART NAME</th><th>PART NUMBER</th><th>QTY</th><th>SOTOON</th><th>ROW</th><th>CONDITION</th><th>PRICE USD</th></tr>

<tr><td><?php echo $SEQ;?></td><td><?php echo $PARTNAME;?></td><td><?php echo $PARTNUMBER;?></td><td><?php echo $QTY;?></td><td><?php echo $SOTOON;?></td><td><?php echo $ROW;?></td><td><?php echo $COND;?></td><td><?php echo $PRICE;?></td></tr>
    ...
    <form name="form1" method="post" action="editt.php">
        <table border="0">
                ...
                <td><textarea rows="6" cols="50" name="COND"><?php echo $COND;?></textarea></td>
                        ...
                        <tr> 
                <td>Update Part#: </td>
                <td><input type="text" name="PARTNUMBER" value="<?php echo $PARTNUMBER;?>"></td>
            </tr>
            <tr> 
                <td>Update Price: </td>
