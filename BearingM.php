...
function goBack() {
   ...
   <title>Bearing DETAILS Search - Secured</title>
</head>
<body>
<?php
...
<div id="w">
   <center> 
   <img src="img/BEARING.jpg"><CENTER><B>DETAILS & STATUS</B></CENTER>
   <form action="BearingMresult.php" class=" sign-in" method="post" name="formu" id="formu">
