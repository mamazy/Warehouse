...
function goBack() {
   ...
   <title>Bearing Part# Search - Secured</title>
</head>
<body>
<?php
...
<div id="w">
   <center> 
   <img src="img/BEARING.jpg"><CENTER><B>PART NUMBER</B></CENTER>
   <form action="Bearingresult.php" class=" sign-in" method="post" name="formu" id="formu">
